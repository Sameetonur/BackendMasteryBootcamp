...
public class EShopDbContext : IdentityDbContext<ApplicationUser, ApplicationRole, string> // bu indirdiğimiz bir paket identity paketi bize rolleri yapmamızı sağlayacak
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.Entity<Product>(entity =>
        {
            ...
            entity.Property(p => p.Properties).IsRequired();
            entity.HasData(
