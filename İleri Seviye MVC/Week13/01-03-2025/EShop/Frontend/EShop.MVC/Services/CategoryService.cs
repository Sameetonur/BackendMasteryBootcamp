...
namespace EShop.MVC.Services
{
    public class CategoryService : ICategoryService
    {
        ...
        public async Task<ResponseModel<List<CategoryModel>>> GetAllDeletedAsync()
        {
            
                var response = await _httpClientService.GetAsync<ResponseModel<List<CategoryModel>>>("categories/get/deleted");
                return response!;
